                     ...
                     if devices_gen.get('Generator') == "ON":
                                   ...
                                   if Length_path == 4: 
                                        for r in range(0,5):
                                              ...
                                              Working_path1 = "/home/"+device_name+"/Roboreactor_projects/" 
                                              ...
                                              Execute_path1 = "/home/"+device_name+"/Roboreactor_projects"+"/Multiple_node_data_projection.py" 
                                              config = configparser.ConfigParser() 
                                              ...
                                              config1.set(settings[0],'Description',"Data_projection_module") 
